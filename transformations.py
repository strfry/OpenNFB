...
class GridFilter(object):
    def __init__(self, samplingFrequency=250, gridFrequency=50.0):
        ...
        nyquistF = samplingFrequency / 2.0
        self.b, self.a = scipy.signal.iirfilter(1, (48. / nyquistF, 52. / nyquistF), btype='bandstop')
    ...
    def update(self, newValue):
        ...
        self.ac = scipy.signal.lfilter(self.b, self.a, filterBuffer - self.dc)[-1]
        # self.ac = scipy.signal.lfilter(self.fir, [1.0], filterBuffer - self.dc)[0
